    ...
    return (
     ...
     {/* PC CSS */}
                ...
                <div className=' flex items-center pt-2 ml-16  w-2/12 '>
                    <input type="text" placeholder='Search' className=' bg-opacity-10 max-sm:hidden  max-lg:ml-20  pl-3 pb-1 placeholder:text-fontnormal  focus:outline-none text-opacity-60 bg-main-dark-bg h-7 rounded-full w-30  border border-fontnormal' />
                    <span>
