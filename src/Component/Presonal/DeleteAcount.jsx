    ...
    <>
      {isShowPrompt && (
        <>
          <div className="fixed top-[30%] md:left-1/2 md:-translate-x-1/2 left-[5%] right-[5%] md:w-[390px] z-50 bg-dark-lighten rounded-md min-h-[100px] shadow-md px-3 py-5 text-center">
            <div className="mx-auto flex items-center justify-center mb-7 h-16 w-16 rounded-full border-[3px] border-red-500 tw-flex-center">
      ...
      <div className="flex justify-center mt-12 mb-6">
        <button
          ...
          className="px-5 py-2  border rounded-lg text-[#Ff0000] border-dark-lighten-2 bg-dark-lighten hover:bg-red-500 hover:text-white transition duration-300"
        >
          Delete account
        </button>
      </div>
