    ...
    <div className="movies-list bg-main-dark-bg pt-4 ">
      <div className='pt-2 pb-4 pl-2 flex flex-row justify-between items-center z-10 relative '>
          ...
          <div className=" flex flex-row  bg-opacity-10 ">
             <button className=" w-6 h-6 mt-3 mr-3 p-0.5 bg-fontnormal  bg-opacity-25 " onClick={() => swiperRef.current?.slidePrev()}>
                <svg  className=" cursor-pointer  w-6 h-6 " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#F9F9F9" >
                <path  strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                </svg>
             </button>
             <button className=" w-6 h-6 mt-3 mr-3 p-0.5 bg-fontnormal bg-opacity-25 " onClick={() => swiperRef.current?.slideNext()}>
              <svg className=" cursor-pointer text-fontactive w-6 h-6 "  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#F9F9F9" >
